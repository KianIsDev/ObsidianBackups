**Attention**
This is a smal project i have been working on for my own entertainment. It should be applicaple by anyone who finds themselves in the same situation, but keep in mind that this is "just" a hobby project to help my study productivity.
...
**Helpful tips**
Create an [lias](https://askubuntu.com/questions/17536/how-do-i-create-a-permanent-bash-alias) to quickly run the program from a terminal.
